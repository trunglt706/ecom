...
class MemberMediaCategory extends Model {
    ...
    |
    */
    protected $fillable = ['category_name', 'data_type', 'display_type', 'attribs', 'parent_category', 'sort'];
    public static $rules = [
    ...
    */
    ...
    public static function fetch($parent_category = 0, $depth = ''){
        $cat = self::select('id', 'category_name as text', 'attribs')->where('parent_category', $parent_category)->orderBy('sort', 'asc')->get();
        $res = [];
        foreach ($cat as $obj) {
