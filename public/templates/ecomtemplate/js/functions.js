...
$(document).ready(function(){
    ...
    (function(){
        $('body').on('click', '#top-search > a', function(e){
            ...
            $('#m-header').addClass('search-toggled');
        ...
        $('body').on('click', '#top-search-close', function(e){
            ...
            $('#m-header').removeClass('search-toggled');
        });
    })();
    ...
    (function(){
        //Toggle
        $('body').on('click', '#menu-trigger, #sidebar-right-trigger', function(e){
            e.preventDefault();
	    ...
	    $('.profile-menu .main-menu').hide();
            ...
            if (x == '#sidebar') {
                ...
                $('#sidebar-right-trigger').removeClass('open');
