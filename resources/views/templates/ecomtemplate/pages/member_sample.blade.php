...
@section('section')
    <section id="member_sample" class="margin-top">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="active">{{ \Language::getTemplate('ecomtemplate.lbl_sample_manager') }}</li>
            </ol>
            <h2 class="text-uppercase" style="font-family: 'Arial'"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i> <strong>{{ \Language::getTemplate('ecomtemplate.lbl_sample_manager') }}</strong></h2>
            <section id="member_model">
                ...
                <div data-bind="visible: view()==='form'" style="display: none;">
                    <form role="form" id="edit-form">
                        @include(Path::viewCurrentTemplate($data['page']->lang, 'forms.member_sample'))
                    </form>
                </div>
            </section>
