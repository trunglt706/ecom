            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <select class="select2" id="category_id" name="category_id" required>
                            @foreach (\DB::table('product_categories')->select('id', 'category_name')->get() as $cat)
...
@section('incFun')
    ...
    self.productPrice = function(){
        $.ajax({url: '{{ $uri }}/product-price', type: 'post', data: {_token: '{{ csrf_token() }}', product_id: self.current().id },
